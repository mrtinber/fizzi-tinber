...
function ArrowButton({ direction, label, onClick }: ArrowButtonProps) {
  return (
    <button
      onClick={onClick}
      className="z-20 size-12 rounded-full border-2 border-white bg-white/10 p-3 opacity-85 focus:outline-none focus-visible:opacity-100 focus-visible:ring-4 md:size-16 lg:size-20"
    >
